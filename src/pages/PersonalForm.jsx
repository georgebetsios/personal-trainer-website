...
export default function FormPage() {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm(
      ...
      import.meta.env.VITE_EMAILJS_TEMPLATE_ID_PERSONAL,
      form.current,
    ...
    <div className="form-page-background">
      <div className="form-page-container">
        ...
        <form ref={form} onSubmit={sendEmail} className="contact-form">
          ...
          <label>Έχεις ξανά γυμναστεί με personal trainer ; *</label>
          <select name="personal_training" required>
          ...
          <label>Έχεις κάποιο τραυματισμό ή χρόνιο πρόβλημα υγείας; *</label>
          <select
            name="health_problem"
            value={hasProblem}
